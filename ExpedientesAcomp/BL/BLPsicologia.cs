...
namespace BL
{
    public class BLPsicologia
    {
        ...
        public BLPsicologia(int id_psicologia, string cedula, string historiaPersonal, string diagnosticoPresuntivo, string objs_Terapeuticos, string tratamient_Empleado, string expediente, 
            string diagnostico_medico, string tratamientos, string motivo_consulta, string composicion_familiar, string laboral_educativos)
        {
