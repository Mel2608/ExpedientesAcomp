...
namespace TO
{
    public class TONutricion
    {
        ...
        public TONutricion(int idNutric, int idExpediente, double pesoResul, string pesoEvaluac, double tallaResult, string tallaEvaluac, double IMCResult, string IMCEvaluac,
