...
namespace TO
{
    public class TOPsicologia
    {
        ...
        public TOPsicologia(int id_psicologia, string cedula, string historiaPersonal, string diagnosticoPresuntivo, string objs_Terapeuticos, string tratamient_Empleado, string expediente,
